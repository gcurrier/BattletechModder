...
- For vanilla items with missing values (e.g melee weapons), DO NOT try to assign values to fields that did not already have a pre-existing value. This is to avoid game-breaking changes...(you have been warned)
...
- this app hasn't been tested on any platform but Windows 10.

- this app was built using IntelliJ with the Maven framework and using Java jre 1.8.0_181. Scenebuilder 8.5 was used in the design of the display definition files (.fxml)
